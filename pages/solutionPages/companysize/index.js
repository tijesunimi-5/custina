...
const index = () => {
  return (
    <div className="companysize m-auto w-[996px] justify-center pr-12 align-center pl-2 ">
      <div className="bg-[#f0f8ff] pt-28 w-[996px] text-black h-[120vh] ml-[-10px] pl-10">
      ...
      <div className="w-[996px] mt-20">
        <div className="w-[950px] m-auto mt-20">
          <h1 className="text-center m-auto text-6xl font-extrabold">
        ...
        <div className="w-[800px] m-auto mt-20">
          <h1 className="text-6xl font-bold text-center ">Easy to use.</h1>
        ...
        <div className="w-[800px] m-auto mt-20">
          <h1 className="text-6xl font-bold text-center ">One platform.</h1>
          <p className="text-4xl font-medium text-center mt-6">
        ...
        <div className="w-[900px] m-auto mt-20">
          ...
          <p className="text-4xl font-medium  mt-6 mb-6">
          ...
          <a className="text-3xl font-normal text-red-500">
