...
const index = () => {
  return (
    <div className="companysize m-auto w-[996px] justify-center pr-12 align-center pl-2 pt-10">
      ...
      <div className="w-[956px] mt-40 m-auto ml-4">
        ...
        <div className="border-[1px] border-black p-10 mt-40 rounded-3xl">
          <h1 className="text-6xl font-bold mb-6">Spend smarter anywhere.</h1>
          ...
          <Link href={"/credit-card"} className="text-3xl text-red-500">
        ...
        <div className="border-[1px] border-black p-10 mt-10 rounded-3xl">
          ...
          <a className="text-3xl text-red-500">
        ...
        <div className="mt-20 m-auto">
          ...
          <p className="mt-10 text-4xl font-semibold text-center text-gray-700">
            Eliminate manual work in every spend workflow from provisioning to
            approvals to VAT tracking.
          </p>
        </div>

        <div className="m-auto mt-44 w-[900px]">
          <h1 className="text-6xl font-bold">
            Enable and control spend efficiently, locally.
          </h1>
          <p className="text-4xl font-semibold mt-10 mb-12">
          ...
          <a className="text-red-500 text-3xl">
            Explore spend controls <FontAwesomeIcon icon={faArrowRight} />
          </a>
        </div>

        <div className="m-auto mt-32 w-[900px]">
          <h1 className="text-6xl font-bold">
        ...
        <div className="mt-40 m-auto">
          ...
          <p className="mt-10 w-[610px] m-auto text-4xl font-semibold text-center text-gray-700">
        ...
        <div className="mt-20 m-auto">
          <h1 className="text-6xl font-bold text-center">Spend reports.</h1>
          <p className="mt-10 w-[610px] m-auto text-4xl font-semibold text-center text-gray-700">
