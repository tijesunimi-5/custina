...
const index = () => {
  return (
    <div className="creditCard m-auto w-[500px] justify-center pr-12 align-center pl-2 pt-10">
      ...
      <div className="w-[720px] pt-32  flex flex-col bg-[#f0f8ff]">
        <h1 className="text-5xl text-center font-bold">
          Corporate credit cards for startups and enterprises.
        </h1>

        <div className="flex w-[720px] text-center  flex-col">
          <div className="bg-gray-200 ml-10 w-[620px] h-[300px] mt-20 rounded-3xl">
            <h1 className="text-4xl pt-10 text-center font-bold">
              Worldwide card acceptance.
            </h1>
            <p className="mt-10 ml-20 text-3xl text-left font-semibold w-[490px]">
          ...
          <div className="flex flex-col w-full justify-center mt-32">
            ...
            <p className="text-3xl pl-10 w-[650px] text-left font-medium mt-9">
              Enable spend for travel, procurement, and more with worldwide card
              acceptance and local cards in 20+ currencies and counting.
            </p>

            <button className="bg-orange-500 rounded-2xl text-white w-[150px] font-medium text-2xl mt-10 ml-10 h-[60px] text-center justify-center">
              Learn more
            </button>
          </div>

          <div className="border border-black flex flex-col mt-44 w-[620px] justify-center rounded-3xl ml-12 text-left">
            <h1 className="text-4xl font-bold pl-10 pt-5">T&E cards</h1>

            <p className="mt-10 font-medium text-3xl pl-10">
              Enable travel expenses and ensure policy compliance with automated
              controls, receipts, and memos.
            </p>

            <div className="text-orange-400 flex text-3xl align-middle pl-10 pt-10 pb-5">
          ...
          <div className="border border-black flex flex-col mt-20 w-[620px] justify-center rounded-3xl ml-12 text-left">
            <h1 className="text-4xl font-bold pl-10 pt-5">Vendor cards</h1>
          ...
          <div className="border border-black flex flex-col mt-20 w-[620px] justify-center rounded-3xl ml-12 text-left">
            <h1 className="text-4xl font-bold pl-10 pt-5">Purchase cards</h1>
          ...
          <div className="border border-black flex flex-col mt-20 w-[620px] justify-center rounded-3xl ml-12 text-left">
            <h1 className="text-4xl font-bold pl-10 pt-5">Benefits cards</h1>
          ...
          <div className="border border-black flex flex-col mt-20 w-[620px] justify-center rounded-3xl ml-12 text-left">
            <h1 className="text-4xl font-bold pl-10 pt-5">You name it</h1>
          ...
          <div className="mt-32">
            ...
            <button className="bg-orange-500 rounded-2xl text-white w-[350px] font-medium text-2xl mt-10 ml-10 h-[70px] text-center justify-center">
              Explore expense management
            </button>
          </div>

          <div className="border  flex flex-col mt-20 w-[620px] justify-center bg-gray-200 rounded-3xl ml-12 text-left">
            <h1 className="text-4xl font-bold pl-10 pt-5">
          ...
          <div className="border bg-gray-200 flex flex-col mt-20 w-[620px] justify-center rounded-3xl ml-12 text-left">
            <h1 className="text-4xl font-bold pl-10 pt-5">
          ...
          <div className="border bg-gray-200 pb-10 flex flex-col mt-20 w-[620px] justify-center rounded-3xl ml-12 text-left">
            <h1 className="text-4xl font-bold pl-10 pt-5">
